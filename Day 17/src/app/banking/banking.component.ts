...
export class BankingComponent implements OnInit {
  ...
  transactions: Transaction[] = [
    { date: '2024-01-01', description: 'Purchase', amount: -40 },
    { date: '2024-01-02', description: 'Deposit', amount: 200 },
    { date: '2024-01-03', description: 'Cosmetic', amount: -100 },
    { date: '2024-01-04', description: 'Credit', amount: 3000 },
    { date: '2024-01-05', description: 'Deposit', amount: 200 },
    { date: '2024-01-06', description: 'Deposit', amount: 200 },
